    ...
    <div className="min-h-screen bg-white text-slate-900 selection:bg-primary/10 overflow-hidden">
        ...
        <div className="container mx-auto text-center max-w-5xl">
          ...
          <ScrollFadeIn delay={100}>
            <h1 className="text-4xl sm:text-6xl md:text-9xl font-display font-bold mb-8 leading-[1.1] md:leading-[0.85] tracking-tighter text-slate-900">
              One page for <br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 via-purple-600 to-emerald-600">all your links.</span>
            </h1>
          </ScrollFadeIn>
      ...
      <section id="features" className="py-20 md:py-32 px-6 relative bg-slate-50/50">
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-24">
            <h2 className="text-4xl md:text-6xl font-display font-bold tracking-tighter mb-6 text-slate-900">What you can do with <span className="text-primary">TapOpen</span></h2>
            ...
            <ScrollFadeIn>
              <div className="space-y-8 text-left">
                ...
                <h2 className="text-4xl md:text-6xl font-display font-bold tracking-tighter leading-tight md:leading-none text-slate-900">
                  One Hub. <br />
                  <span className="opacity-20 text-slate-400">Show your work too.</span>
                </h2>
      ...
      <section id="platform" className="py-20 md:py-32 overflow-hidden border-b border-slate-100">
        <div className="text-center mb-16">
          <p className="text-[10px] font-black uppercase tracking-[0.4em] text-slate-400">Works with every app you already use</p>
        </div>
      ...
      <section className="py-32 md:py-48 px-6 text-center relative">
        ...
        <div className="container mx-auto max-w-4xl">
          <ScrollFadeIn>
            ...
            <p className="text-lg text-slate-500 mb-10 font-medium">Pick a name, add your links, share one URL. That's it.</p>
        ...
        <div className="container mx-auto max-w-7xl">
          <div className="grid md:grid-cols-4 gap-12 mb-20">
            <div className="col-span-2 space-y-6">
              ...
              <p className="text-slate-900 font-bold text-sm">One page for all your links.</p>
              <p className="text-slate-400 max-w-xs leading-relaxed font-medium">Links that open apps, not broken browsers.</p>
            </div>
            <div>
          ...
          <div className="pt-12 border-t border-slate-200 flex flex-col md:flex-row justify-between items-center gap-6">
            <p className="text-[10px] font-black uppercase tracking-[0.4em] text-slate-300">© 2025 TapOpen. Every link, working right.</p>
